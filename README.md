...
- **[`results/FINDINGS.md`](results/FINDINGS.md)** — generated-code (codegen) defects, tracked
...
| [`results/FINDINGS.md`](results/FINDINGS.md) | generated-code weakness log (codegen defects → the generator) |
