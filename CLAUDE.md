...
| [`docs/STATUS-LOG.md`](docs/STATUS-LOG.md) | the dated, session-by-session work journal (history behind STATUS.md) — read for how a finding was resolved, not the current tally. |
