...
| [`results/FINDINGS.md`](results/FINDINGS.md) | **the** findings **index** — one row per entry (F-00NN, and codegen defects G-00NN), carrying only the link, the upstream ticket and the state. |
