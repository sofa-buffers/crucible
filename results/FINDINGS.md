...
| G-0019 (= F-0034) | [generator#224](https://github.com/sofa-buffers/generator/issues/224) | 🔴 **OPEN** — dart backend's generated `onFixlenHeader` enforces a fixlen field's `maxlen` without gating on the wire subtype, rejecting a §7.3-skippable fp64-at-blob field. Crucible finding **F-0034** |
...
**Status:** 🔴 **OPEN** — [generator#224](https://github.com/sofa-buffers/generator/issues/224). Finding
