...
|---|---|---|---|---|
| [F-0001](../findings/F-0001-truncated-trailing-varint/NOTES.md) | truncated trailing varint: two camps — C/C++/Rust/Java/C# accept, Go+Python+TS reject (7 vs 4) | {c,cpp,c-cpp,rust-std,rust-nostd,java,csharp} vs {go,py-cython,py-pure,typescript} | verdict | open — pending spec (PLAN §8) |
...
Python, Java, TypeScript, and C#) grew it from 1-vs-1 into a 7-accept-vs-4-reject
**two-camp** split — three independent lineages (Go, Python, TypeScript) reject
where the C/C++/Rust/Java/C# camp accepts. That is exactly the extra signal more
