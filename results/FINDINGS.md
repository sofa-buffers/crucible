...
| [F-0003](../findings/F-0003-rust-array-oob-panic/NOTES.md) | Rust decoder panics (index OOB) on an over-long array — crash/DoS | corelib-rs, corelib-rs-no-std | crash → **verdict** | ⚠️ crash fixed ([generator#78](https://github.com/sofa-buffers/generator/issues/78) closed); **residual divergence untracked** — rust-std/nostd now accept, 10 others reject (verified @ sofabgen 0.15.1) |
