...
|---|---|---|---|---|
| [F-0001](../findings/F-0001-truncated-trailing-varint/NOTES.md) | truncated trailing varint: two camps — C/C++/Rust/Java accept, Go+Python reject (6 vs 3) | {c,cpp,c-cpp,rust-std,rust-nostd,java} vs {go,py-cython,py-pure} | verdict | open — pending spec (PLAN §8) |
...
Python, and Java) grew it from 1-vs-1 into a 6-accept-vs-3-reject **two-camp**
split — two independent lineages (Go, Python) reject where the C/C++/Rust/Java
camp accepts. That is exactly the extra signal more implementations buy: a lone
outlier is ambiguous; two independent rejects point at the answer.
