...
it.** This is no longer a lone outlier: two unrelated implementations agreeing on
*reject* is strong evidence the lenient camp is wrong. The wire is an incomplete
