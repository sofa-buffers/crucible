...
("MUST both reject"). **Re-verified on 0.17.5:** unchanged. (2026-07-17) Codegen weakness **G-0013** (`results/FINDINGS.md`). Target repo:
...
terminates (**or OOMs for a huge id**)" — and `results/FINDINGS.md`'s G-0011 row repeats it
